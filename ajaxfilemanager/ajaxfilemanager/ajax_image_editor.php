<?php
	...
	if(CONFIG_SYS_VIEW_ONLY || !CONFIG_OPTIONS_EDITABLE)
	{
		...
		$imageInfo = $image->getImageInfo($path);
                //$relpath = explode('D:/mprojects/campsite', $path);
                $relpath = explode('/home3/campingb/public_html', $path);
                $relpath = 'http://www.campingbooker.com'.$relpath[1];
                //$relpath = 'http://192.168.0.135:3131'.$relpath[1];
	?>
...
<div id="imageArea">
    <div id="imageContainer">
    	<img src="<?php echo $relpath; ?>" name="<?php echo basename($path); ?>" width="<?php echo $imageInfo['width']; ?>" height="<?php echo $imageInfo['height']; ?>" />
    </div>
    <div id="resizeMe">
    	<div id="resizeSE"></div>
    	<div id="resizeE"></div>
