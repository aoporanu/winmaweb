...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', CONFIG_SYS_MY_DOCROOT . '/media/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', CONFIG_SYS_MY_DOCROOT . '/media/');	//accept relative path only
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,pdf,doc,docx'); // 
