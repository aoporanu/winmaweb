...
/* myaccount/listPendingFriends.twig */
class __TwigTemplate_5577458c8988eea0faade8091c399b7f extends Twig_Template
{
    ...
    {
        // line 15
        echo "\t<h1>My Pending Friends List</h1>
...
\t<a href=\"";
        ...
        echo "\" class=\"g-button g-button-submit ajax-link\" style=\"min-width:10px;\">Pending Friends</a>
\t<a href=\"";
        // line 21
        if (isset($context["router"])) { $_router_ = $context["router"]; } else { $_router_ = null; }
...
\t\t\t\t\t\t<a href=\"";
                ...
                echo "\" class=\"g-button g-button-share modal-normal-with-close\" id=\"remove_pending_friend\" title=\"Remove Pending Request\">Remove Request</a>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t\t";
            }
...
";
    ...
    {
        return "myaccount/listPendingFriends.twig";
    }
