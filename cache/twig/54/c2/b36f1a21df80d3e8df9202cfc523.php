...
/* myaccount/sentMessages.twig */
class __TwigTemplate_54c2b36f1a21df80d3e8df9202cfc523 extends Twig_Template
{
...
\t\t<a href=\"";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($_router_, "url_for", array("@myAccountMyReceivedMessages", ), "method"), "html", null, true);
        echo "\" class=\"g-button g-button-submit ajax-link\" style=\"min-width:10px;\">My Received Messages</a>
\t\t<a href=\"";
        // line 20
        if (isset($context["router"])) { $_router_ = $context["router"]; } else { $_router_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_router_, "url_for", array("@myAccountMySentMessages", ), "method"), "html", null, true);
        echo "\" class=\"g-button ajax-link\" style=\"min-width:10px;\">My Sent Messages</a>
\t\t<a href=\"";
        // line 21
        if (isset($context["router"])) { $_router_ = $context["router"]; } else { $_router_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_router_, "url_for", array("@myAccountMyMessages", ), "method"), "html", null, true);
        echo "\" class=\"g-button g-button-submit ajax-link\" style=\"min-width:10px;\">Send Message</a>
\t\t<br />
\t\t<br />
\t\t";
        // line 24
...
\t\t\t\t<div class=\"yui3-u\" style=\"width:80px;\">";
                ...
                echo "</div>
\t\t\t\t<div class=\"yui3-u\" style=\"width:300px;\"><a href=\"";
                // line 35
                if (isset($context["router"])) { $_router_ = $context["router"]; } else { $_router_ = null; }
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
...
\t\t\t\t\t<a href=\"";
                ...
                if (isset($context["router"])) { $_router_ = $context["router"]; } else { $_router_ = null; }
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_router_, "url_for", array(("@myAccountSenderDeleteMessage?id=" . $this->getAttribute($_message_, "id")), ), "method"), "html", null, true);
...
";
    ...
    {
        return "myaccount/sentMessages.twig";
    }
