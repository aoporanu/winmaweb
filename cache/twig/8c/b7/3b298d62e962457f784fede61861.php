...
/* myaccount/messenger/sent-messages.twig */
class __TwigTemplate_8cb73b298d62e962457f784fede61861 extends Twig_Template
{
...
\t\t<a href=\"";
        ...
        echo "\" class=\"g-button ajax-link g-button-submit\" style=\"min-width:10px;\">My Sent Messages</a>
\t\t<a href=\"";
        // line 21
        if (isset($context["router"])) { $_router_ = $context["router"]; } else { $_router_ = null; }
...
\t\t\t\t<div class=\"yui3-u\" style=\"width:80px;\">";
                ...
                echo "</div>
\t\t\t\t<div class=\"yui3-u\" style=\"width:300px;\"><a class=\"received-message-link\" href=\"";
                // line 35
                if (isset($context["router"])) { $_router_ = $context["router"]; } else { $_router_ = null; }
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
...
";
    ...
    {
        return "myaccount/messenger/sent-messages.twig";
    }
